...
if ((html.match(/class="prompt-record"/g) ?? []).length !== 5) failures.push("Expected 5 verbatim prompt records");
if (!html.includes("And then whne this is all done")) failures.push("Latest prompt is not preserved verbatim");
